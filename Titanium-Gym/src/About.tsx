    ...
    <div className="about">
      ...
      <div className="about-team">
        ...
        <div className="team-members">
          <AboutTeamMember
            image="src/Images/AboutPerson1.jpg"
            name="Emily Collins"
          ...
          ></AboutTeamMember>
          <AboutTeamMember
            image="src/Images/AboutPerson2.jpg"
            name="Mark Johnson"
          ...
          ></AboutTeamMember>
          <AboutTeamMember
            image="src/Images/AboutPerson3.jpg"
            name="Sarah Roberts"
          ...
          ></AboutTeamMember>
          <AboutTeamMember
            image="src/Images/AboutPerson4.jpg"
            name="Alex Ramirez"
          ...
          ></AboutTeamMember>
          <AboutTeamMember
            image="src/Images/AboutPerson5.jpg"
            name="Jessica Chen"
          ...
          ></AboutTeamMember>
          <AboutTeamMember
            image="src/Images/AboutPerson6.jpg"
            name="David Lee"
          ...
          ></AboutTeamMember>
          <AboutTeamMember
            image="src/Images/AboutPerson7.jpg"
          ...
          ></AboutTeamMember>
          <AboutTeamMember
            image="src/Images/AboutPerson8.jpg"
            name="Ryan Cooper"
